// Run with in cl
/*
cl.exe function_composition.cpp /I ../../range-v3/include /std:c++latest /permissive- /experimental:preprocessor
*/
...
int main()
{
    ...
    auto total = ranges::accumulate(
        view::ints(100, 1000) | view::transform([](int x) { return x * x; }) |
            view::take(100),
        0);
